...
This folder defines all source code for the 'user_sdp_example' pipeline:
...
* Take a look at the sample under "sample_users_user_sdp_example.py" to get familiar with the syntax.
